...
public interface JoinMeet<Ty> extends top.JoinMeet<Ty>, record.JoinMeet<Ty> {
  ...
  interface Join<Ty> extends TyAlgDefault<Ty, IJoin<Ty>>, JoinMeet<Ty>, top.JoinMeet.Join<Ty>, record.JoinMeet<Ty> {
    default Zero<IJoin<Ty>> m() {
      return top.JoinMeet.Join.super.m();
    }
  }

  interface Meet<Ty> extends TyAlgDefault<Ty, IMeet<Ty>>, JoinMeet<Ty>, top.JoinMeet.Meet<Ty>, record.JoinMeet<Ty> {

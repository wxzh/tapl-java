...
public interface Meet<Ty> extends TyAlgQuery<Ty, IMeet<Ty>>, JoinMeet<Ty>, bot.Meet<Ty>, fullsub.Meet<Ty> {
	@Override
	...
	@Override
	default IMeet<Ty> TySource(Ty ty1) {
		return ty -> matcher()
	...
	@Override
	default IMeet<Ty> TySink(Ty ty1) {
		return ty -> matcher()
